...
namespace GUI
{
    public class ExcelExport
    {
        ...
        public const string T_HoaDon2 = "HoaDon2";
        public const string T_HoaDon1 = "HoaDon1";
        #endregion
        ...
        private string SaveFile(bool pIsPrint = true)
        {
            ...
            SaveFileDialog saveFileDialog = new SaveFileDialog();
            saveFileDialog.Filter = Constants.FILTER_EXCEL2007;
            saveFileDialog.AddExtension = true;
            saveFileDialog.DefaultExt = Constants.FILE_EXT_XLSs;
        ...
        /// <param name="fileName">Name of the file.</param>
        /// <returns></returns>
        private bool OutSimpleReport<T>(List<T> dataSource, List<T> dataDV, Dictionary<string, string> replaceValues, string viewName, bool isPrintPreview, ref string fileName)
        {
            ...
            if (!(dataDV == null || (dataDV != null && dataDV.Count == 0)))
            {
                markProcessor.AddVariable("DichVu", dataDV);
            }
            ...
            file = Path.GetTempFileName() + Constants.FILE_EXT_XLSs;
                                        ...
                                        string groupBox, string viewName, bool isPrintPreview, ref string fileName, string groupName)
        {
            ...
            fileName = Path.GetTempFileName() + Constants.FILE_EXT_XLSs;
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_HoaDon2:
                    ...
                    arrByte = File.ReadAllBytes("HoaDon2.xlsx").ToArray();
                    break;

                case T_HoaDon1:
                    // path += Constants.FILE_KEHOACHTD;
                    arrByte = File.ReadAllBytes("HoaDon1.xlsx").ToArray();
                    break;
                    #endregion
            }
            // Get stream
        ...
        public bool ExportHoaDon(List<Object> dataSource, List<Object> dataDV, HoaDon hd, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            replacer.Add("%MaHD", hd.MaHD.ToString());
            replacer.Add("%NgayLap", hd.NgayThanhToan.ToString());
            replacer.Add("%TongTien", hd.TongTien.ToString());
            replacer.Add("%NguoiLap", hd.NhanVien.HoTenNV);

            return OutSimpleReport(dataSource, dataDV, replacer, viewName, isPrintPreview, ref fileName);
        }
        #endregion
    }
}
